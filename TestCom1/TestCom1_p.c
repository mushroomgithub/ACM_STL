...
/* Object interface: IFun, ver. 0.0,
   GUID={0xC5E06306,0x1ACF,0x414F,{0xAF,0x62,0xC7,0x8C,0xE0,0x98,0x98,0xE9}} */
...
CINTERFACE_PROXY_VTABLE(5) _IFunProxyVtbl = 
{
    &IFun_ProxyInfo,
    &IID_IFun,
...
const CInterfaceStubVtbl _IFunStubVtbl =
{
    &IID_IFun,
    &IFun_ServerInfo,
    5,
...
const CInterfaceProxyVtbl * _TestCom1_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IFunProxyVtbl,
    0
};

const CInterfaceStubVtbl * _TestCom1_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IFunStubVtbl,
    0
};

PCInterfaceName const _TestCom1_InterfaceNamesList[] = 
{
    "IFun",
    0
};
...
#define _TestCom1_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _TestCom1, pIID, n)

int __stdcall _TestCom1_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_TestCom1_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo TestCom1_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _TestCom1_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _TestCom1_StubVtblList,
    (const PCInterfaceName * ) & _TestCom1_InterfaceNamesList,
    0, // no delegation
    & _TestCom1_IID_Lookup, 
    1,
    2,
